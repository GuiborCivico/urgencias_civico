...
z1_ev_PAR60 <- ppar_60(a1_base, 0.2, m1, "01_basico")
...
z1_ev_PAR60 <- rbind(z1_ev_PAR60,ppar_60(a1_base,0.2,m2,"02_persona"))
...
z1_ev_PAR60 <- rbind(z1_ev_PAR60,ppar_60(a1_base,0.2,m3,"03_ingresos"))
...
z1_ev_PAR60 <- rbind(z1_ev_PAR60,ppar_60(a1_base,0.2,m4,"04_bancario"))
...
z1_ev_PAR60 <- rbind(z1_ev_PAR60,ppar_60(a1_base,0.2,m5,"05_gestion"))
...
z1_ev_PAR60 <- rbind(z1_ev_PAR60,ppar_60(a1_base,0.2,m6,"06_formalidad"))
...
z1_ev_PAR60 <- rbind(z1_ev_PAR60,ppar_60(a1_base,0.2,m7,"07_comunidad"))
...
z1_ev_PAR60 <- rbind(z1_ev_PAR60,ppar_60(a1_base,0.2,m8,"08_autopercepcion"))
...
z1_ev_PAR60 <- rbind(z1_ev_PAR60,ppar_60(a1_base,0.2,m9,"09_caracter"))
...
z1_ev_PAR60 %>% reshape2::melt(id.vars = c("Modelo","Umbral"), 
  ...
  labs(title = "Simulaciones simples PAR60",
...
ggsave("2. Proyectos/05_tips_comercial_inicial/01_simulacion_PAR60.png")
